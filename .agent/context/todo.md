...
## Completado ✅ (Phases 0–7 + pulido + sync + UX fixes)
...
- Rest timer: solo manual (no auto-start al añadir/completar serie)
- Rest timer: vibración al terminar en vez de push notification
